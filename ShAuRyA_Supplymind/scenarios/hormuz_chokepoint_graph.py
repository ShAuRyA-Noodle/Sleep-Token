...
NODES: list[dict] = [
    ...
    {"id": "IRAN", "label": "Iran",
     ...
     "source": "https://www.iea.org/articles/the-strait-of-hormuz-is-the-world-s-most-important-oil-transit-chokepoint",
     "agency": "IEA"},
    ...
    {"id": "HABSHAN_FUJAIRAH", "label": "Habshan–Fujairah pipeline",
     ...
     "source": "https://www.adnoc.ae/en/news-and-media",
     "agency": "ADNOC"},
