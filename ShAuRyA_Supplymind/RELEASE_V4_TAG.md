...
→ `ShAuRyA_Supplymind/features/R9_ANALYST_AB_V5.json`
...
`ShAuRyA_Supplymind/autoresearch/AUTORESEARCH_LAB_NOTEBOOK.md` (auto-generated).
...
→ `ShAuRyA_Supplymind/features/port_imagery/assessments.json`
...
pytest tests/ ShAuRyA_Supplymind/tests/ -q  # 250 passing

# Reproduce the two v4 headline numbers:
bash ShAuRyA_Supplymind/receipts/V4_Analyst_V5_Exact_Acc.reproduce.sh  # -> 0.8
bash ShAuRyA_Supplymind/receipts/V4_Autoresearch_Best_CI95.reproduce.sh # -> 0.4548
