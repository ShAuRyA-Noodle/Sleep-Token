...
Usage:
    ...
    #   ollama create supplymind-analyst:v5 -f ShAuRyA_Supplymind/features/Modelfile.analyst_v5
    # Then run:
    python -m ShAuRyA_Supplymind.features.analyst_ab_bench --save
...
def benchmark(v5_model: str, base_model: str) -> dict:
    ...
    if v5_model not in tags:
        return {"status": "v5_not_built",
                "hint": f"ollama create {v5_model} -f ShAuRyA_Supplymind/features/Modelfile.analyst_v5",
