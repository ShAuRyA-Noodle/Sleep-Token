...
- `AUTORESEARCH_SUMMARY.md`: Phase I 10-experiment HPO summary (best config preserved in `rl/autoresearch_final.json`).
- `supplymind_plan.md`, `adaptive-tickling-bubble.md`: v1 architecture exploration.
