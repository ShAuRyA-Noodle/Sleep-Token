...
MODELS: list[ModelSpec] = [
    ...
    ModelSpec("nousresearch/hermes-3-llama-3.1-405b", "hermes-3-405b",
              "405B", 131_000, "judge",
              "Frontier agentic — paid route ($1/M tok, ~$0.04/run)"),
    ...
    ModelSpec("qwen/qwen3-next-80b-a3b-instruct", "qwen3-next-80b",
              "80B MoE / 3B active", 262_000, "judge",
              "Stable reasoning — paid route (~$0.055/run)"),
    ModelSpec("z-ai/glm-4.5-air:free", "glm-4.5-air",
              "MoE w/ thinking", 131_000, "judge",
              "Configurable reasoning depth"),
    ModelSpec("meta-llama/llama-3.3-70b-instruct", "llama-3.3-70b",
              "70B dense", 131_000, "judge",
              "Meta SOTA baseline — paid route (~$0.005/run)"),
    ...
    # --- red-team / code -------------------------------------------------
    ModelSpec("qwen/qwen3-coder-flash", "qwen3-coder-flash",
              "Qwen3 coder flash", 1_000_000, "red-team",
              "Adversarial reward-hack generator — paid flash route (~$0.08 for 10 attacks)"),
    # --- vision / multimodal ---------------------------------------------
    ...
    # --- utility tier ----------------------------------------------------
    ModelSpec("meta-llama/llama-3.2-3b-instruct", "llama-3.2-3b",
              "3B", 80_000, "utility",
              "Cheap text — paid route (~$0.016/run)"),
