...
cp -v ../Sleep-Token/v3_arcadia/results/R6_EUCLIDIAN.json         examples/supplymind/benchmarks/
cp -v ../Sleep-Token/v3_arcadia/results/R6_GETHSEMANE.json        examples/supplymind/benchmarks/
cp -vr ../Sleep-Token/v3_arcadia/checkpoints/onnx_bundle/*         examples/supplymind/policies/ 2>/dev/null || \
...
cp -v ../Sleep-Token/ShAuRyA_Phoenix/upstream_prs/meta_openenv/README.supplymind.md \
...
echo "    --body-file ../Sleep-Token/ShAuRyA_Phoenix/upstream_prs/meta_openenv/PR.md"
