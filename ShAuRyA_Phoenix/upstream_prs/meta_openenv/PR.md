...
Source -> Target:
```
v3_arcadia/results/R6_EUCLIDIAN.json              -> examples/supplymind/benchmarks/R6_EUCLIDIAN.json
v3_arcadia/checkpoints/onnx_bundle/*              -> examples/supplymind/policies/
...
`ShAuRyA_Phoenix/upstream_prs/meta_openenv/build_pr_branch.sh`.
