...
```
ShAuRyA_Phoenix/roll_integration/env/supplymind_roll_env.py         -> examples/supplymind_crisis/supplymind_roll_env.py
ShAuRyA_Phoenix/roll_integration/reward_bridge/supplymind_judge_worker.py -> examples/supplymind_crisis/supplymind_judge_worker.py
ShAuRyA_Phoenix/roll_integration/configs/dpo_qwen25_3b_supplymind.yaml -> examples/supplymind_crisis/configs/dpo_qwen25_3b_supplymind.yaml
ShAuRyA_Phoenix/roll_integration/configs/agentic_supplymind_gigpo.yaml -> examples/supplymind_crisis/configs/agentic_supplymind_gigpo.yaml
ShAuRyA_Phoenix/roll_integration/dpo_judge/data/preference_pairs.jsonl -> examples/supplymind_crisis/data/preference_pairs.jsonl
ShAuRyA_Phoenix/upstream_prs/alibaba_roll/README.crisis.md          -> examples/supplymind_crisis/README.md
```

Build script: `ShAuRyA_Phoenix/upstream_prs/alibaba_roll/build_pr_branch.sh`.
