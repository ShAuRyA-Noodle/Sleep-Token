...
cp -v ../Sleep-Token/ShAuRyA_Phoenix/roll_integration/env/supplymind_roll_env.py \
      examples/supplymind_crisis/
cp -v ../Sleep-Token/ShAuRyA_Phoenix/roll_integration/reward_bridge/supplymind_judge_worker.py \
      examples/supplymind_crisis/
cp -v ../Sleep-Token/ShAuRyA_Phoenix/roll_integration/configs/*.yaml \
      examples/supplymind_crisis/configs/

if [ -f ../Sleep-Token/ShAuRyA_Phoenix/roll_integration/dpo_judge/data/preference_pairs.jsonl ]; then
  cp -v ../Sleep-Token/ShAuRyA_Phoenix/roll_integration/dpo_judge/data/preference_pairs.jsonl \
...
cp -v ../Sleep-Token/ShAuRyA_Phoenix/upstream_prs/alibaba_roll/README.crisis.md \
...
echo "    --body-file ../Sleep-Token/ShAuRyA_Phoenix/upstream_prs/alibaba_roll/PR.md"
