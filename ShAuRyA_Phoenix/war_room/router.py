...
def war_room(req: WarRoomRequest):
    ...
    scene_1_live_shock = {
        ...
        "_evidence": provenance.Evidence(
            ...
            publisher="NewsAPI + FRED" if not live["served_from_replay"] else "ShAuRyA_Phoenix replay_cache",
            url=("https://newsapi.org/, https://fred.stlouisfed.org/" if not live["served_from_replay"]
                 else "ShAuRyA_Phoenix/realtime_v5/replay_cache_latest.json"),
        ).to_dict(),
    }
    ...
    scene_2_chokepoint = {
        ...
        "_evidence": provenance.Evidence(
            ...
            artifact_path="ShAuRyA_Phoenix/scenarios/hormuz_chokepoint_atlas.json",
    ...
    scene_3_india = {
        ...
        "_evidence": provenance.Evidence(
            source_type="internal_artifact",
            artifact_path="ShAuRyA_Phoenix/scenarios/india_supply_chain_exposure.json",
    ...
    if req.include_gulf:
        ...
        scene_4_gulf = {
            ...
            "_evidence": provenance.Evidence(
                source_type="internal_artifact",
                artifact_path="ShAuRyA_Phoenix/scenarios/gulf_supply_chain_exposure.json",
