# ShAuRyA_Phoenix — v5 Ascensionism Layer

> "Ashes don't forget, they remember forward."

This directory contains the **Phoenix v5 ascensionism layer** being built on top of:
- `v3_arcadia/` (frozen at commit `02251e9` — the v3 ashes)
- `ShAuRyA_Supplymind/` (frozen as v4.0-arcadia-live — the first phoenix)

**Phoenix v5 is isolated by directive.** If anything here fails, `v3_arcadia/` and `ShAuRyA_Supplymind/` remain a complete, self-sufficient top-10 hackathon submission. Every new capability lives here.
...
- **v3 and v4 are untouched.** `tests/` and `ShAuRyA_Supplymind/tests/` (249 total) must stay green throughout Phoenix work.
...
pytest tests/ ShAuRyA_Supplymind/tests/ -q

# Phoenix tests (new)
pytest ShAuRyA_Phoenix/tests/ -q
...
bash ShAuRyA_Phoenix/receipts_v2/<claim>.reproduce.sh
```

---

*Phoenix v5 plan: `ShAuRyA_Supplymind/docs/PHOENIX_PLAN_V5.md` (Sections 10–16 cover ROLL + Superpowers deep integration).*
