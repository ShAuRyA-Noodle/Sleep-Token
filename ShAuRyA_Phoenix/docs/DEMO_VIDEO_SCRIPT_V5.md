...
**Commands**:
```bash
uvicorn ShAuRyA_Phoenix.server.phoenix_app:app --port 8000 &
sleep 3
...
**Commands**:
```bash
cat ShAuRyA_Phoenix/autoresearch_fixed/lab_notebook.md | head -40
...
bash ShAuRyA_Phoenix/receipts_v2/R6_MaskingAblation_easy_lift.reproduce.sh
# -> 26.77
