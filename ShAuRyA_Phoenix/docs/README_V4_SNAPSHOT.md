...
├── docs/core/DATA_SOURCES.md        # Real-world calibration sources (40+ citations)
└── README.md
```
...
See `docs/v3/EXECUTIVE_SUMMARY.md` for the full report and `FAILURE_TABLE.md` for deferred items.
